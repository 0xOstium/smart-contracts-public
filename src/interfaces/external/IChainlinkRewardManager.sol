...
import './IChainlinkVerifierFeeManager.sol';
...
interface IRewardManager is IERC165 {
    ...
    function setRewardRecipients(
        bytes32 poolId,
        IVerifierFeeManager.AddressAndWeight[] calldata rewardRecipientAndWeights
    ) external;
     ...
     */
    function updateRewardRecipients(bytes32 poolId, IVerifierFeeManager.AddressAndWeight[] calldata newRewardRecipients)
        external;
